export default function Home() {
    return (
        <div className='terms-of-use'>
            <article>
                <h1>1. Welcome to ExtraTerrestrial.Finance(“we,” “us,” or “our”)the informational resource for ExtraTerrestrial Protocol, as defined below.</h1>
                <p>Effective Date: November 6th, 2022</p>
                <p> ExtraTerrestrial.Finance provides information and resources about the fundamentals of the decentralized 
                    non-custodial liquidity protocol called the ExtraTerrestrial Protocol (the “ExtraTerrestrial Protocol” or “Protocol”). 
                    ExtraTerrestrial.Finance is not one of the available access points to the ExtraTerrestrial Protocol.
                </p>
                <p> ARBITRATION NOTICE: THESE TERMS (“TERMS”) CONTAIN AN ARBITRATION CLAUSE BELOW. EXCEPT FOR CERTAIN
                    ...
                    INCLUDE OUR VARIOUS WEBSITES, INCLUDING, WITHOUT LIMITATION, ExtraTerrestrial.Finance (AND ANY RESPECTIVE
                    ...
                    THESE TERMS, ExtraTerrestrial.Finance - PRIVACY POLICY (FOUND HERE), AND OTHER POLICIES REFERENCED HEREIN
                ...
                <p>
                    As a condition to accessing or using the Site or Interface, you represent and warrant to ExtraTerrestrial.finance the following:
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        jurisdiction over ExtraTerrestrial.finance or you as otherwise duly enacted, 
                ...
                <p>
                    ...
                    Services at contact@ExtraTerrestrial.finance. When you communicate with us electronically, you consent to
            ...
            <article>
                <h2>ExtraTerrestrial.Finance is provided as an informational resource.</h2>
                <p>ExtraTerrestrial.Finance provides resources about the fundamentals of the 
                    ExtraTerrestrial Protocol, which is a fully decentralized, community governed 
                    protocol deployed on multiple blockchain networks and systems, and 
                    provides information about the wider ExtraTerrestrial ecosystem, governance, 
                    community, and various interfaces and integrations to the ExtraTerrestrial 
                    ...
                    resource. Because the Site provides information about the ExtraTerrestrial 
                ...
                <h2>We are software developers in the ExtraTerrestrial Protocol ecosystem.</h2>
                <p>
                    It is important to understand that neither we nor any affiliated entity is a party to any
                    transaction on
                    the blockchain networks underlying the ExtraTerrestrial Protocol; we do not have possession, custody or
                    control
                    ...
                    when
                    you interact with any ExtraTerrestrial Protocol smart contracts, you retain control over your cryptoassets
                    at
                ...
                <h2>
                    The ExtraTerrestrial Protocol is deployed on multiple blockchain-based networks, and we are not responsible
                    for
                    the operation of such networks.
                </h2>
                <p> The software underlying blockchain networks on which the ExtraTerrestrial Protocol is deployed, including,
                    for
                    ...
                    operation of the blockchain-based software and networks underlying the ExtraTerrestrial Protocol, (ii) that
                ...
                <h2>ExtraTerrestrial Ecosystem and Community contributors are independent.</h2>
                <p>All community contributors to the ecosystem around the ExtraTerrestrial Protocol are independent of us, and
                    we
            ...
            <article>
                ...
                <p>Transactions on the ExtraTerrestrial Protocol rely on smart contracts stored on various blockchains,
                ...
                <p>
                    ...
                    that you will not seek to hold any ExtraTerrestrial.Finance Party responsible for any
                    consequent
                    losses.
                </p>
            ...
            <article>
                ...
                <p>
                    ...
                    materials that you may access or use on or through the Services; however, the code for the ExtraTerrestrial
                    Protocol
                    and the front-end interface (app.ExtraTerrestrial.finance) deployed on IPFS is open-sourced. Except as
                    expressly set
            ...
            <article>
                ...
                <p>
                    ...
                    EMPLOYEES,
                    AGENTS, REPRESENTATIVES, PARTNERS, AND LICENSORS (COLLECTIVELY, THE “ExtraTerrestrial.Finance INDEMNIFIED
                    PARTIES”)
                    MAKE NO GUARANTEES OF ANY KIND IN CONNECTION WITH THE SERVICES. TO THE MAXIMUM EXTENT PERMITTED
                    UNDER
                    APPLICABLE LAW, THE ExtraTerrestrial.Finance INDEMNIFIED PARTIES DISCLAIM ALL WARRANTIES AND CONDITIONS,
                    WHETHER
                ...
                <ul>
                    ...
                    <li>
                        ...
                        THAT
                        THE ExtraTerrestrial.Finance INDEMNIFIED PARTIES ARE NOT RESPONSIBLE FOR LOSS OR DAMAGE CAUSED BY
                        ANOTHER
                ...
                <p>
                    Limitation of Liability. TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL ANY ExtraTerrestrial.Finance
                ...
                <p>
                    IN ADDITION TO THE FOREGOING, NO ExtraTerrestrial.Finance INDEMNIFIED PARTY SHALL BE LIABLE FOR ANY
                    DAMAGES
                    CAUSED
                ...
                <p>
                    ...
                    WHETHER OR
                    NOT THE ExtraTerrestrial.Finance INDEMNIFIED PARTIES HAVE BEEN INFORMED OF THE POSSIBILITY OF ANY SUCH
                    DAMAGE.
                </p>
                <p>
                    IN NO EVENT WILL THE ExtraTerrestrial.Finance INDEMNIFIED PARTIES’ CUMULATIVE LIABILITY TO YOU OR ANY
                    OTHER
                    USER,
                ...
                <p>
                    UNDER NO CIRCUMSTANCES SHALL ANY ExtraTerrestrial.Finance INDEMNIFIED PARTY BE REQUIRED TO DELIVER TO YOU
                    ANY
                ...
                <p>
                    ...
                    to
                    you. To the extent applicable law does not permit ExtraTerrestrial.Finance Indemnified Parties to
                    disclaim
                    certain
                    warranties or limit certain liabilities, the extent of ExtraTerrestrial.Finance Indemnified Parties’
                    liability and
            ...
            <article>
                ...
                <p>You agree to indemnify, defend, and hold harmless the ExtraTerrestrial.Finance Indemnified Parties from
                    any
                    claim or
            ...
            <article>
                ...
                <p>
                    ...
                    consent to
                    any ExtraTerrestrial.Finance Indemnified Party, or to its successors in the interest of any business
                    associated
            ...
            <article>
                ...
                <p>
                    ...
                    The Agreement (including, without limitation, these Terms, and the ExtraTerrestrial.Finance Privacy
                    Policy)
                    and any
